        ...
        {numSelected > 0 ? (
          ...
          >
            <div className={Styles.tabletop}>
              ...
              <span className={Styles.tablename}></span>{" "}
            </div>
          </Typography>
        )}
...
export default function EnhancedTable({
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = workflows.map((n) => n._id);
              ...
              <TableContainer>
                ...
                >
                  ...
                  <TableBody>
                    ...
                    {stableSort(workflows, getComparator(order, orderBy))
                      .slice(
                        page * rowsPerPage,
                        ...
                        return (
                          ...
                          >
                            <TableCell padding="checkbox">
                              <Checkbox
                                onClick={(event) =>
                                  handleClick(event, workflow._id)
                                }
