            ...
            <div className={Styles.tabletop}>
              ...
              <span className={Styles.tablename}>
                <button onClick={() => handleCreateRole(size)}>
                  <i className="fa fa-plus pr-2"></i> Create Role
                </button>
              </span>{" "}
            </div>
          </Typography>
...
export default function EnhancedTable(props, { preview }) {
  ...
  const handleShowMore = (event, gotrole, newSize) => {
      ...
      <Paper>
        ...
        <TableContainer>
          ...
          >
            ...
            />
            <TableBody>
              {stableSort(roleStore.role, getComparator(order, orderBy))
                .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                .map((gotrole, index) => {
                  const isItemSelected = isSelected(gotrole._id);
                  ...
                  return (
                    ...
                    >
                      <TableCell padding="checkbox">
                        <Checkbox
                          onClick={(event) => handleClick(event, gotrole._id)}
          ...
          <Drawer onClose={onClose} isOpen={isOpen} size={size}>
            <DrawerContent>
              <DrawerBody>
                ...
                />
                <div className={Styles.vendortitle}>Role</div>
                ...
                <div className={Styles.vendor}>
                  <span className={Styles.vendornamelabel}>Staus: </span>
              ...
              <DrawerBody>
                <Row>
                  <Col>
                    ...
                    />
                    <div className={Styles.heading}>Edit Role</div>
                    <Form1
                      ref={form}
                      onSubmit={(e) => {
                        e.preventDefault();
